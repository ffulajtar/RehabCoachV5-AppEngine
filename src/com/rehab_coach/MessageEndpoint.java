 ...
 */
@Api(name = "messageEndpoint", namespace = @ApiNamespace(ownerDomain = "rehab_coach.com", ownerName = "rehab_coach.com", packagePath=""))
...
public class MessageEndpoint {
   ...
   */
  private static final String API_KEY = "AIzaSyAiJU7ASEYnCUcs64xEy5itKFCsLiFaqiU";
